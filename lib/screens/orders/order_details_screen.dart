...
class OrderDetailsScreen extends StatelessWidget {
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: const Text("Order Receipt", style: TextStyle(color: Color(0xFF1A1D25), fontWeight: FontWeight.w800, fontSize: 18)),
              centerTitle: true,
            ),
            leading: Padding(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildLogisticsCard(riderName, riderPhone, address, isActive),
                  const SizedBox(height: 32),
  ...
  Widget _buildLogisticsCard(String riderName, dynamic riderPhone, String address, bool isActive) {
    return Container(
      padding: const EdgeInsets.all(24),
        ...
        children: [
          _logisticsRow(
            ...
            trailing: riderPhone != null ? IconButton(
              ...
              icon: const Icon(Icons.phone_in_talk_rounded, color: accentGreen, size: 20),
              style: IconButton.styleFrom(backgroundColor: accentGreen.withValues(alpha: 0.1)),
            ) : null
          ),
          const SizedBox(height: 20),
          _logisticsRow(Icons.location_on_rounded, "Shipping To", address, isSmall: true),
        ],
      ),
    );
  }
